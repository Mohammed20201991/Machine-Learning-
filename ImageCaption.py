'''Given a subset of the COCO Image Captioning dataset
define hyperparameters to train an Encoder-Decoder with Attention model such that it achieves at least a BLEU score of 0.2 on the test set. Students need to achieve at least 0.2
'''
#Libraries / packages
